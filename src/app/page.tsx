    ...
    <WalletProvider wallets={wallets} autoConnect>
      <WalletModalProvider>
        <main className={styles.main}>
          ...
          {loading && (
            <div className={styles.confirmationBox1}>
              <div className={styles.loadingtext}>Confirming the transaction</div>
              <img src="loadingicon.gif" alt="Tick Icon" className={styles.tickIcon} />
            </div>
          )}
          {minted5 && (
              <div className={styles.confirmationBox2}>
